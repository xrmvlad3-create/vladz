  ...
  if (!session || role !== "admin") {
    return (
      <main>
        ...
        <p style={{ marginTop: 8 }}>
          Te rugăm să te <a href="/login?callbackUrl=/admin/courses" style={{ color: "#2563eb" }}>autentifici</a> ca administrator.
        </p>
      </main>
    );
  }
    ...
    <main>
      ...
      <section style={{ border: "1px solid #e5e7eb", borderRadius: 10, padding: 12, background: "#fff", marginBottom: 12 }}>
        ...
        <form action={createOrUpdateCourse} style={{ display: "grid", gap: 8, gridTemplateColumns: "repeat(3, minmax(0,1fr))" }}>
          ...
          <input name="teamSlug" placeholder="teamSlug (opțional)" style={{ border: "1px solid #e5e7eb", borderRadius: 8, padding: "8px 10px" }} />
